...
COPY env/SE3Transformer/se3_transformer se3transformer/se3_transformer
COPY env/SE3Transformer/setup.py se3transformer/
RUN python3 -m pip install --no-cache-dir --no-deps se3transformer/
